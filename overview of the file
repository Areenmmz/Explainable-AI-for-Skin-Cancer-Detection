...
"We are building a tool that makes skin cancer detection smarter and more transparent. Using a trained Deep Learning model, the system analyzes skin images to identify potential cancer. 
To ensure doctors can trust these results, the system also 'explains' its reasoning by highlighting the specific areas of the skin lesion it found suspicious."
